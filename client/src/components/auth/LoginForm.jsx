  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-b from-indigo-900 via-purple-900 to-indigo-800 py-12 px-4 sm:px-6 lg:px-8 relative">
      ...
      <div className="max-w-md w-full space-y-8 relative z-10">
        <div>
          <h2 className="mt-6 text-center text-3xl font-extrabold text-white">Welcome back, Hero!</h2>
          <p className="mt-2 text-center text-sm text-indigo-200">Sign in to continue your comic journey</p>
        </div>
