...
const applyCoupon = async () => {
   ...
   try {
      const response = await axios.post("http://localhost:5002/api/discounts/apply", {
        ...
        <PayPalButtons
          ...
          createOrder={async (data, actions) => {
            try {
              ...
              const response = await axios.post(
                "http://localhost:5002/api/paypal/create-order",
                {
                  formData,
          ...
          onApprove={async (data, actions) => {
            try {
              ...
              const response = await axios.post(
                "http://localhost:5002/api/paypal/capture-order",
