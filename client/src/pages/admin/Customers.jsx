...
const Customers = () => {
  ...
  const fetchCustomers = async () => {
    ...
    try {
      const response = await axios.get(`${import.meta.env.VITE_API_BASE_URL}/api/users/admin`, {
  ...
  const fetchQueries = async () => {
    ...
    try {
      const response = await axios.get(`${import.meta.env.VITE_API_BASE_URL}/api/queries/admin`, {
        headers: { Authorization: `Bearer ${token}` },
      });
